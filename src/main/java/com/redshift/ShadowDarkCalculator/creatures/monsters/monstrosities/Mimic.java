 ...
 * AC 12, HP 23, ATK 2 bite +5 (1d8 + stick), MV near
 * S +2, D +0, C +1, I -2, W +0, Ch -3, AL N, LV 5
...
public class Mimic extends Monster {
    ...
    private static class Bite extends Weapon {
        ...
        private Bite() {
            ...
            addPiercing().addAttackRollBonus(3);
        }
        ...
        public void perform(Creature actor, List<Creature> enemies, List<Creature> allies, Encounter encounter) {
            ...
            if (mimic.getCurrentStuckTarget() == null) {
                ...
                if (target == null) {
                    ...
                    boolean attackHit = performSingleTargetAttack(actor, target, getName(), damageDice, rollModifier);
                ...
                if (mimic.getCurrentStuckTarget().isDead() || mimic.getCurrentStuckTarget().isUnconscious()) {
                    ...
                    if (mimic.getCurrentStuckTarget().hasCondition(mimic.currentStuckCondition)) {
                        ...
                        mimic.getCurrentStuckTarget().takeDamage(damage, damageType);
                    } else {
